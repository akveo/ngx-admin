...
import 'style-loader!./ba-menu.component.scss';

@Component({
  selector: 'ba-menu',
  templateUrl: './ba-menu.component.html'
})
export class BaMenu implements OnDestroy, OnInit {
  ...
  public updateMenu(newMenuItems: Array<any>) {
  ...
  public toggleSubMenu($event: any): boolean {
    const submenu: any = jQuery($event.currentTarget).next();
